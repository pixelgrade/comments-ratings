PixReviews [![Build Status](https://travis-ci.org/pixelgrade/pixreviews.svg?branch=dev)](https://travis-ci.org/pixelgrade/pixreviews)
========
**A Theme Customizer Booster**

With PixReviews, you can easily add Fonts, Colors, Live CSS Editor and other options to your theme.

### How to use it?

First you need to install and activate the stable version. This will always be on [wordpress.org](https://wordpress.org/plugins/pixreviews/)
...
The PixReviews [$config](#about_config_var) can be filtered by any theme and this is how you do it, include this filter in your theme(probably in functions.php)

```
 // Advice: change this function's name and make sure it is unique

add_filter('pixreviews_filter_fields', 'make_this_function_name_unique' );
...
The PixReviews plugin also create's its own defaults this way. You can see that in `pixreviews/pixreviews_config.php`
Personally I like to simply copy this file in my child theme and include it in `functions.php` with

`require 'pixreviews_config.php'`
...
This is the array which is processed by the `pixreviews_filter_fields` filter and it contains:
...
'theme_style'   => array(
	'type'      => 'preset',
	'label'     => __( 'Select a style:', 'pixreviews_txtd' ),
	'desc' => __( 'Conveniently change the design of your site with built-in style presets. Easy as pie.', 'pixreviews_txtd' ),
	'default'   => 'silk',
	'choices_type' => 'select',
	'choices'  => array(
		'silk' => array(
			'label' => __( 'Silk', 'pixreviews_txtd' ),
			'options' => array(
		...
		'red' => array(
			'label' => __( 'Urban', 'pixreviews_txtd' ),
			'options' => array(
				'links_color' => 'red',
				'headings_color' => 'red',
				'body_color' => 'red',
		...
		'black' => array(
			'label' => __( 'Black', 'pixreviews_txtd' ),
			'options' => array(
				'links_color' => '#ebebeb',
				'headings_color' => '#333',
				'body_color' => '#989898',
...
'presets_section' => array(
	'title'    => __( 'Style Presets', 'pixreviews_txtd' ),
	'options' => array(
		'theme_style'   => array(
			'type'      => 'preset',
			'label'     => __( 'Select a style:', 'pixreviews_txtd' ),
			...
			'choices'  => array(
				'royal' => array(
					'label' => __( 'Royal', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#ffffff',
				...
				'lovely' => array(
					'label' => __( 'Lovely', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#ffffff',
				...
				'queen' => array(
					'label' => __( 'Queen', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#fbedec',
				...
				'carrot' => array(
					'label' => __( 'Carrot', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#ffffff',
				...
				'adler' => array(
					'label' => __( 'Adler', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#fff',
				...
				'velvet' => array(
					'label' => __( 'Velvet', 'pixreviews_txtd' ),
					'preview' => array(
						'color-text' => '#ffffff',
